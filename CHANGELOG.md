...
- `npm run typecheck` and all 877 tests pass, including mailbox recovery, lane status, hard timeout bounds, caller identity, and resident lease progress coverage.
